...
public class IuSubjectConfirmationValidationTest   {
	...
	public void testLocalAddressValidation() throws AssertionValidationException {
		...
		IuSubjectConfirmationValidator validator = new IuSubjectConfirmationValidator(Arrays.asList(SUBJECT_CONFIRMATION_LOCAL_ADDRESS), false);
		...
		ValidationResult result = validator.validateAddress(subjectConfirmationData,assertion , validationContext, false);
