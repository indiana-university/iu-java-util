...
/**
 * Manages client-side session state. TODO implement session support mechanism
 * for SAML
 */
public interface IuSamlSession {
	 ...
	 * 
	 */
	IuSamlPrincipal authorize(InetAddress address, URI postUri, String samlResponse, String relayState)
